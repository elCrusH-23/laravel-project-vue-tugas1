                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="NIP"type="text" class="form-control" placeholder="NIP">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <button v-on:click.prevent="storeDaftardosen" type="submit" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <template v-for="item in data_daftardosen">
                                <tr>
                                    <td>@{{ item.nama }}</td>
                                    <td>@{{ item.email }}</td>
                                    <td>@{{ item.phone }}</td>
        ...
        var vue = new Vue({
            ...
            getData: function() {
                axios.get(this.url, {
                    ...
                    .then(resp => {
                        this.data_daftardosen =resp.data.data;
                ...
                editData: function(id) {
                    ...
                    var url ="{{ url('get-daftardosen') }}" + '/' + id;

                    axios.get(url)
                        .then(res => {
                            var daftardosen =res.data;
                            this.nama = daftardosen.nama;
                            this.email = daftardosen.email;
                            this.phone = daftardosen.phone;
                            this.NIP = daftardosen.NIP;
                            this.type = daftardosen.type;
                ...
                hapusData: function(id){
                    var url ="{{ url('hapus-daftardosen')}}" +'/'+id;
